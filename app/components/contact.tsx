...
export default function Contact() {
  ...
  return (
    <div className="relative h-screen w-full flex flex-col items-center antialiased">
      <motion.section
        id="contact"
        ref={ref}
        // min means pick smaller value. 100% or 38rem. on wider viewport, it will be 38rem. On a smaller viewport, it will be 100%.
        className="scroll-mt-32 mb-20 sm:mb-28 w-[min(100%,38rem)] text-center h-[40rem]"
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <p
          ...
          className="text-zinc-700 -mt-6 dark:text-white/80 relative"
        >
